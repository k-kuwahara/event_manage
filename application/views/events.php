                        ...
                        <tbody>
                            <form action="/events" name="deleteEvent" method="post">
                                ...
                                <?php foreach ($events as $event): ?>
                                    <tr>
                                        <td class="alignC"><?= $event->event_date ?></td>
                                        <td class="alignC"><?= $event->event_title ?></td>
                                        <td class="alignC"><a href="mailto:<?= $event->email ?>"><?= $event->email ?></a></td>
                                        ...
                                        <td class="alignC"><button type="button" class="detail" onclick="lfDeleteEvent(<?= $event->event_id ?>);">削除</button></td>
                                    </tr>
                                <?php endforeach; ?>
                            </form>
                        </tbody>
